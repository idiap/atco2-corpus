...
# output folder
data=$EXP_FOLDER/atco2_test_set_1h; mkdir -p $data/prep

keyprefix=atco2_test-set-1h_
sampling_rate=16000
...
cp $data/valid/{utt2spk,spk2utt,text,stm,reco2file_and_channel,segments,wav.scp} $data/
